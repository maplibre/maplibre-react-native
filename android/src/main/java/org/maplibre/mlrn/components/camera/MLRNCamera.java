package org.maplibre.mlrn.components.camera;
...
import org.maplibre.mlrn.events.MapUserTrackingModeEvent;
import org.maplibre.mlrn.events.MapChangeEvent;
import org.maplibre.mlrn.location.LocationManager;
import org.maplibre.mlrn.location.UserLocation;
import org.maplibre.mlrn.location.UserLocationVerticalAlignment;
import org.maplibre.mlrn.location.UserTrackingMode;
import org.maplibre.mlrn.location.UserTrackingState;
...
public class MLRNCamera extends AbstractMapFeature {
    ...
    private void setInitialCamera() {
        if (mDefaultStop != null) {
            ...
            mDefaultStop.setMode(org.maplibre.mlrn.components.camera.constants.CameraMode.NONE);
