package org.maplibre.rctmln.components.camera;
...
import org.maplibre.rctmln.events.MapUserTrackingModeEvent;
import org.maplibre.rctmln.events.MapChangeEvent;
import org.maplibre.rctmln.location.LocationManager;
import org.maplibre.rctmln.location.UserLocation;
import org.maplibre.rctmln.location.UserLocationVerticalAlignment;
import org.maplibre.rctmln.location.UserTrackingMode;
import org.maplibre.rctmln.location.UserTrackingState;
...
public class RCTMLNCamera extends AbstractMapFeature {
    ...
    private void setInitialCamera() {
        if (mDefaultStop != null) {
            ...
            mDefaultStop.setMode(org.maplibre.rctmln.components.camera.constants.CameraMode.NONE);
