...
class MLRNPointAnnotationManager(
    ...
    override fun createViewInstance(reactContext: ThemedReactContext): MLRNPointAnnotation = MLRNPointAnnotation(reactContext)

    override fun addView(
        parent: MLRNPointAnnotation,
        child: View,
        index: Int,
    ) {
    ...
    override fun getChildCount(parent: MLRNPointAnnotation): Int = parent.childCount
    ...
    override fun setId(
        ...
        id?.let { annotation.mapLibreId = it }
    }
