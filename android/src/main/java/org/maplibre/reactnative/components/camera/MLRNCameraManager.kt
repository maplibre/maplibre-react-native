...
class MLRNCameraManager(private val mContext: ReactApplicationContext) :
    ...
    @ReactProp(name = "stop")
    override fun setStop(camera: MLRNCamera, value: ReadableMap?) {
    ...
    override fun setMinZoom(camera: MLRNCamera, value: Double) {
        camera.setMinZoomLevel(value)
    }

    @ReactProp(name = "maxZoom")
    override fun setMaxZoom(camera: MLRNCamera, value: Double) {
        camera.setMaxZoomLevel(value)
    }

    @ReactProp(name = "maxBounds")
    override fun setMaxBounds(camera: MLRNCamera, value: ReadableArray?) {
        camera.setMaxBounds(GeoJSONUtils.toLatLngBounds(value))
    }

    @ReactProp(name = "trackUserLocation")
    override fun setTrackUserLocation(camera: MLRNCamera, value: String?) {
