...
class MLRNRasterSourceManager(
    ...
    override fun createViewInstance(themedReactContext: ThemedReactContext): MLRNRasterSource = MLRNRasterSource(themedReactContext)

    @ReactProp(name = "tileSize")
    fun setTileSize(
        source: MLRNRasterSource,
        tileSize: Int,
    ) {
