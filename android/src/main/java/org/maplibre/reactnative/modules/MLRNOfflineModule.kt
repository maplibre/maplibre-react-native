...
class MLRNOfflineModule(
    ...
    override fun setMaximumAmbientCacheSize(
        size: Double,
        promise: Promise,
    ) {
        activateFileSource()
    ...
    override fun pausePackDownload(
        id: String,
        promise: Promise,
    ) {
        activateFileSource()
    ...
    override fun resumePackDownload(
        id: String,
        promise: Promise,
    ) {
        activateFileSource()
    ...
    override fun mergeOfflineRegions(
        path: String,
        promise: Promise,
    ) {
        activateFileSource()
    ...
    private fun setOfflineRegionObserver(
        id: String,
    ...
    private fun getBoundsFromOptions(options: ReadableMap): LatLngBounds {
        ...
        val bounds =
            GeoJSONUtils.toLatLngBounds(boundsArray)
