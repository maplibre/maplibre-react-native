...
Callout that displays information about a selected annotation near the<br/>annotation.
...
| `style`         | `ViewStyle` | `none`  | `false`  | Style property for the CalloutNativeComponent.<br/><br/>Use at your own risk. |
