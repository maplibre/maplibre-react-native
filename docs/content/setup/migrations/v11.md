...
- Type-safe autocomplete using `LayerSpecification` from `@maplibre/maplibre-gl-style-spec`
...
```tsx
import { Layer, type LayerSpecification } from "@maplibre/maplibre-react-native";
