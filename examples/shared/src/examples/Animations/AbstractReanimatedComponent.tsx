...
const AnimatedViewAnnotation = Animated.createAnimatedComponent(ViewAnnotation);

interface AbstractReanimatedComponentProps {
  component: "Marker" | "ViewAnnotation";
}
...
export function AbstractReanimatedComponent({
  component,
}: AbstractReanimatedComponentProps) {
  ...
  const AnnotationComponent = {
    ...
    ViewAnnotation: AnimatedViewAnnotation,
  }[component];
