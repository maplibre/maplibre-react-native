...
@property (nonatomic, strong, nonnull) NSMutableDictionary<NSString*, NSMutableArray<FoundLayerBlock>*> *layerWaiters;
...
@property (nonatomic, strong, nullable) NSDictionary<NSString *, NSNumber *> *reactAttributionPosition;
...
- (nonnull MLRNSource *)getTouchableSourceWithHighestZIndex:(nonnull NSArray<MLRNSource *> *)touchableSources;
