...
- (void)prepareView {
  ...
  // just need to pass something, it won't really be used on fabric, but it's used to create events
  // (it won't impact sending them)
  _view.reactTag = @-1;
  ...
  //      std::dynamic_pointer_cast<const facebook::react::RNMBXMapViewEventEmitter>(
