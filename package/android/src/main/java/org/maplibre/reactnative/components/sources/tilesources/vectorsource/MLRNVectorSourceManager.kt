...
class MLRNVectorSourceManager(
    ...
    override fun createViewInstance(themedReactContext: ThemedReactContext): MLRNVectorSource = MLRNVectorSource(themedReactContext)
}
