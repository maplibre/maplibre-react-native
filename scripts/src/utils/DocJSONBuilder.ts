...
const COMPONENT_DIRECTORY = path.join(PACKAGE_ROOT, "src", "components");
const MODULES_DIRECTORY = path.join(PACKAGE_ROOT, "src", "modules");
          ...
          for (const module of modules) {
            ...
            if (
              ...
              results[name] = {
                name,
                type: "module",
                filePath: path.relative(PACKAGE_ROOT, module.context.file),
