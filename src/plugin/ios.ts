 ...
 * TODO: In the future this should be removed in favor of some custom hooks provided by Expo autolinking.
 */
...
const withDwarfDsym: ConfigPlugin = (config) => {
  return withXcodeProject(config, async (config) => {
    config.modResults.debugInformationFormat = "dwarf-with-dsym";
